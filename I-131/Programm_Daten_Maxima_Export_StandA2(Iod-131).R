...
Daten_Maxima_Export<-data.frame(Longitude_Maxima,Latitude_Maxima,Daten_Maxima$Aktivität,Daten_Maxima$Zeitdauer_Transport, Daten_Maxima$Zeit_Auftreffen,Daten_Maxima$Freisetzung_Kraftwerk ) #6. Komponente jetzt Freisetzungszeit
View(Daten_Maxima_Export)
...
#Daten exportieren
write.csv(Daten_Maxima_Export,c(paste0( "Daten_Maxima/Daten für Maxima_Export_Gesamt(Iod-131Erste7Tage).csv")), row.names = FALSE)
